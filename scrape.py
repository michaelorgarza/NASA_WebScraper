...
def scrape():
    ...
    mars_data["Mars_Facts"] = mars_html_tablestring
    ...
    for i in range(1,9,2):
        ...
        hemi_name_urls = hemi_soup.find_all('a', class_='product-item')
        hemi_name = hemi_name_urls[i].text.strip('Enhanced')
        ...
        image_dict['title'] = hemi_name.strip()
        image_dict['img_url'] = hemi_img_path
        hemi_dicts.append(image_dict)
